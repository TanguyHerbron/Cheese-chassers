...
public class Modele {
    ...
    private int cptSouris = 20;
    private int cptCartes = 40;
    private int cptChats = 7;
    private int cptFromages = 9;
    private int cptPieges = 4;
    private int x = 40;
    private int y = 40;
    ...
    public int determinerCarte() {
        ...
        Log.d("alea", String.valueOf(alea));
        return alea;
    }
